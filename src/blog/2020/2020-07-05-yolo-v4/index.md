...
- **Two-stage** object-detection models – There are mainly two stages in these classification based
  ...
  [Faster R-CNN](https://arxiv.org/abs/1506.01497), [Mask R-CNN](https://arxiv.org/abs/1703.06870)
  etc.
...
{% fig "https://res.cloudinary.com/sadanandsingh/image/upload/v1596231167/yolo-v4/backbone.png", "A typical backbone network" %}
...
{% fig "https://res.cloudinary.com/sadanandsingh/image/upload/v1596231168/yolo-v4/object_detection2.png", "Anatomy of Different Types of Detectors" %}
...
{% fig 'https://res.cloudinary.com/sadanandsingh/image/upload/v1596231169/yolo-v4/yolo-loss.png', "Loss Function" %}
...
{% fig 'https://res.cloudinary.com/sadanandsingh/image/upload/v1596231169/yolo-v4/pan-yolo.png', "YOLO-v4 version of the Path Aggregation Network" %}
...
{% fig 'https://res.cloudinary.com/sadanandsingh/image/upload/v1596231168/yolo-v4/dropblock.png', "Regular Pixel Dropout vs DropBlock" %}
...
{% fig 'https://res.cloudinary.com/sadanandsingh/image/upload/v1596231167/yolo-v4/bifpn.png', "Different Variants of Pyramid Networks for Detection" %}
...
{% fig "https://res.cloudinary.com/sadanandsingh/image/upload/v1596231168/yolo-v4/diou.jpg" %}
...
{% fig "https://res.cloudinary.com/sadanandsingh/image/upload/v1596231167/yolo-v4/ciou.jpg" %}
...
{% fig "https://res.cloudinary.com/sadanandsingh/image/upload/v1596231167/yolo-v4/cmbn.jpg" %}
...
{% fig "https://res.cloudinary.com/sadanandsingh/image/upload/v1596231167/yolo-v4/box_calc.jpg" %}
...
{% fig 'https://res.cloudinary.com/sadanandsingh/image/upload/v1596231168/yolo-v4/sam.jpg', "A typical Spatial Attention Module" %}

This spatial attention mask is applied to the input feature to output the refined feature maps.

{% fig 'https://res.cloudinary.com/sadanandsingh/image/upload/v1596231167/yolo-v4/conv_sam.jpg', "A typical Convolutional Spatial Attention Module" %}

In YOLOv4, a modified SAM is used without applying the maximum and average pooling.

{% fig 'https://res.cloudinary.com/sadanandsingh/image/upload/v1596231168/yolo-v4/sam-yolo.png', "YOLO V4 version of Spatial Attention Module" %}
...
A comparison of results for YOLOv4 with other object detection models on MS COCO dataset with
Maxell GPU is shown in the table below. In particular here we are looking only for speed
(FPS - frames per second), and accuracy (AP - average pecision and AP_small - average precision
for small objects only).

<ResultsTable data={resData} id='test' />
...
{% fig 'https://res.cloudinary.com/sadanandsingh/image/upload/v1596231168/yolo-v4/yolo_results.png', "Summary of Results" %}
